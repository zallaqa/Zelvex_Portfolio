  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="container">
        ...
        <Image src={computerImage} className="size-[100px]" alt="coding img" />
        ...
        <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Building Exceptional User Expreriences</h1>
        <p className="mt-4 text-center text-white/60 md:text-lg">
        I’m a passionate Full-Stack Developer
  crafting seamless web experiences with modern technologies
  like React, Node.js, and MongoDB. Let’s bring your ideas to life!
        </p>
        </div>
